...
export const TOOL_ACCESS: Record<string, ToolAccess> = {
  ...
  query_events:          'read',
  get_wechat_messages:   'read',
  send_wechat_message:   'destructive',
  get_qq_messages:       'read',
  send_qq_message:       'destructive',
  get_telegram_messages: 'read',
  send_telegram_message: 'destructive',
  get_discord_messages:  'read',
  send_discord_message:  'destructive',
