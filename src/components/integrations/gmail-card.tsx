          ...
          <div className="space-y-4 rounded-lg border border-border bg-muted/30 p-4">
            ...
            <ol className="space-y-2 text-xs text-muted-foreground list-none">
              {[
                ...
                <>Go to <a href="https://console.cloud.google.com/apis/library" target="_blank" rel="noreferrer" className="text-primary underline inline-flex items-center gap-0.5">APIs &amp; Services → Library <ExternalLink className="h-3 w-3" /></a>. Search for <strong className="text-foreground">Gmail API</strong> and click <strong className="text-foreground">Enable</strong>. Then search for <strong className="text-foreground">Google Calendar API</strong> and enable it too.</>,
                ...
                <>In the left sidebar go to <strong className="text-foreground">Audience → Test users → Add users</strong>. Add your Gmail address and click <strong className="text-foreground">Save</strong>. <span className="italic">If you already have a client set up, skip to step 8.</span></>,
